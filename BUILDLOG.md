...
- Tests run and result: `scripts/dev.py test` - format, lint, strict mypy, 1,006 passed and 9 skipped.
- Commit/link/path: `src/acvp_assay/models.py`, `src/acvp_assay/reporter.py`, `src/acvp_assay/diff.py`, `src/acvp_assay/runner.py`, `src/acvp_assay/algorithms/`, `docs/architecture.md`, `README.md`.
- Blocker, if any: none.
- Next unchecked ID: the README headline, which gives the totals without saying how unevenly they fall.

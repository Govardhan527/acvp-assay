...
The current baseline includes UTF-8 JSON file loading, path-specific validation, normalization into immutable typed models, and the runtime-metadata seam. Provider operations, comparison, and reporting remain isolated behind their numbered backlog tasks.
